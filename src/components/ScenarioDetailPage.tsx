    ...
    <Layout>
      ...
      <section className="container grid min-w-0 gap-6 py-12 lg:grid-cols-[minmax(0,1fr)_360px]">
        <article className="panel min-w-0 rounded-lg p-6 sm:p-8">
          <Link
            className="mb-8 inline-flex items-center gap-2 text-sm text-[var(--accent-text)]"
            href="/examples"
          >
            <ArrowLeft size={18} /> Back to all
          </Link>
          <p className="eyebrow">{liveScenario.category}</p>
          <h1 className="mt-3 break-words text-4xl font-medium text-[var(--text-primary)] md:text-6xl">
          ...
          <div className="my-8 grid min-w-0 gap-5 border-y border-[var(--neutral-line-soft)] py-8 sm:grid-cols-2">
            <div className="min-w-0">
              <p className="eyebrow">Today</p>
              <p className="mt-4 break-words text-3xl text-[var(--text-primary)]">
              ...
              <p className="mt-2 break-words text-[var(--text-muted)]">
          ...
          <div className="rounded-lg border border-[var(--accent-line)] bg-[var(--accent-surface)] p-6">
            <p className="eyebrow mb-3">The takeaway</p>
            <p className="text-2xl leading-9 text-[var(--text-primary)]">
      ...
      {landingContent && (
        <section className="border-y border-[var(--neutral-line-soft)] bg-[var(--surface-card)] py-14">
      ...
      {landingContent && (
        <section className="container py-14">
          <div className="flex flex-col justify-between gap-5 border-b border-[var(--neutral-line-soft)] pb-8 sm:flex-row sm:items-end">
            <div>
            ...
            {relatedScenarios.map((relatedScenario) => (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between gap-4">
                  ...
                  <ArrowRight
                    size={20}
                    className="text-[var(--accent-text)] transition-transform group-hover:translate-x-1"
                  />
                </div>
              </Link>
            ))}
          ...
          <p className="max-w-4xl text-sm leading-6 text-[var(--text-subtle)]">
