...
const tiers = [
  ...
  },
  {
    ...
    body: "A light account gives you one saved scenario and a basic watchlist view.",
    cta: "Save a Scenario",
    href: "/calculator",
    featured: false,
    checkoutPlanIds: [],
  },
  {
    ...
    body: "Unlimited saved scenarios, full watchlist, daily snapshots, in-app weekly reports, and historical comparison.",
